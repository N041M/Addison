...
| [`step-8-automation-plan.md`](step-8-automation-plan.md) | **NOT STARTED** — written 2026-08-07. Build order for OS-run automation and the per-automation-nonce keyword gate: four phases (the fence + the table, authoring, the gate + arming, state honesty + Simple). The nonce decision is the owner's (2026-08-07); the plan's §5 settles the engineering decisions around it. |
