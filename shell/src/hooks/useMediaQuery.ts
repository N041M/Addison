// useMediaQuery — a tiny dependency-free media-query hook (docs/design-brief-dark,
...
// CSS alone (the slide-over drawer, the widgets flowing inline at the foot of the
// thread, where consent cards render) key off `useMediaQuery("(max-width:
// 767.98px)")`, while purely visual changes (hit-target sizes, paddings) stay in
// Tailwind `max-md:`/`md:` variants.
//
